...
namespace ArtNotes.UndergroundLaboratoryGenerator
{
    ...
    {
        [TextArea] public string Description = "use it on empty obj with Camera as children. WASDQE - walk, RT - rotation, Shift - run";
        ...
        private float xmouse, ymouse, yRotation, Speed, upaxe, rotate_on_key;
        ...
        private void Update() // camera rotation
        {
            //axis
